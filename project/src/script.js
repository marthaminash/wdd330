fetch(
  "https://api.openweathermap.org/data/2.5/weather?q=Chicago&appid=8adbbd0d7569023dba5ab7e20a2e5cd6"
)
  .then(function (resp) {
    return resp.json();
  })
...
function displayWeatherCondition(response) {
  ...
  if (readyWeatherDescription === "Thunderstorm") {
    ...
    readyWeatherDescription === "Mist" ||
    readyWeatherDescription === "Smoke" ||
    readyWeatherDescription === "Haze" ||
    readyWeatherDescription === "Dust" ||
    readyWeatherDescription === "Fog" ||
    readyWeatherDescription === "Sand" ||
    readyWeatherDescription === "Ash" ||
    readyWeatherDescription === "Squall" ||
    readyWeatherDescription === "Tornado"
  ) {
    ...
    if (index < 6) {
      forecastHTML =
        ...
        <div class="day day-section-1">
                ...
                <div class="day-emoji"><img src="img/${
                  forecastDay.weather[0].main
                }.png" alt="weather emoji"></div>
                <div class="day-temperature"><span id="forecast-max-temp"><strong>${Math.round(
                  forecastDay.temp.max
                )}</strong></span><strong>°C</strong>/<span id="forecast-min-temp">${Math.round(
